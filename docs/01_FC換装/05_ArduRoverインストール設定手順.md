...
2026-06-10現在の `params/tuned/20260610_before_tune.param` では `BATT_VOLT_MULT=18.62`。走行前に通常給電・テスター実測・Mission Planner表示を再比較し、`18.182`と`18.62`のどちらを採用するか [ArduRoverパラメータ](06_ArduRoverパラメータ.md) と [チューニングログ](../02_チューニング/09_チューニングログ.md) に記録する。
