> 元ファイル: `C:\Users\ta1na\source\rover-gcs\README.md`
> 取得日: 2026-06-08
> 種別: 概要資料
...
（事前にスクリプト内の `WINDOWS_IP` を修正する必要があります。詳細は `08_Webotsセットアップ手順.md` を参照）
...
> セットアップ詳細は `08_Webotsセットアップ手順.md` を参照してください。
...
本番サーバーへのデプロイ手順の詳細は [05_GCSデプロイ手順.md](05_GCSデプロイ手順.md) を参照してください。
...
![System Architecture](../画像/GCSシステム構成図.png)

より詳細な構成やデータフローについては `03_GCSシステム構成.md` を参照してください。

**ハードウェア仕様**: 実機の構成やパーツ一覧は `01_実機ハードウェア構成.md` をご覧ください。

## ドキュメント

- **プロジェクト資料**:
  - [01_Rover開発PRJ_概要.pdf](../PDF資料/Rover開発PRJ概要.pdf)
  - [02_Rover開発PRJ_技術資料.pdf](../PDF資料/Rover開発PRJ技術資料.pdf)
- **アーキテクチャ**: [`03_GCSシステム構成.md`](03_GCSシステム構成.md) — システム構成とデータフローの詳細
- **デプロイ手順**: [`05_GCSデプロイ手順.md`](05_GCSデプロイ手順.md) — 本番デプロイと Docker 構成の説明
- **ハードウェア仕様**: [`01_実機ハードウェア構成.md`](01_実機ハードウェア構成.md) — 実機のパーツ一覧と配線図
- **システム仕様書**: [`04_GCSシステム仕様.md`](04_GCSシステム仕様.md) — 要求仕様・設計仕様のまとめ
- **Webots シミュレーション**:
  - [概要 (Summary)](07_Webots概要.md)
  - [詳細ガイド (Setup Guide)](08_Webotsセットアップ手順.md)
  - [WebRTC連携 (WebRTC Integration)](09_Webots_WebRTC連携.md)
...
- ローバー写真 (実機):
  ...
  ![Rover photo](../画像/実機写真_20251220.jpg)

- フロントエンド: カメラ表示スクリーンショット

  ![WGCS Camera view](../画像/GCSカメラ表示.jpg)

- YOLO / 距離表示デモ

  ![YOLO and Range demo](../画像/GCS_YOLO距離表示.jpg)
