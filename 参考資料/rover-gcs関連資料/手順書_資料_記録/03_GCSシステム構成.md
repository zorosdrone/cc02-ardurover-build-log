> 元ファイル: `C:\Users\ta1na\source\rover-gcs\docs\architecture.md`
> 取得日: 2026-06-08
> 種別: 構成資料
...
- **WebRTC (VDO.Ninja)**
    ...
    - **注意:** ブラウザでカメラ権限を使うため、通常は **HTTPS が必須** です（[05_GCSデプロイ手順.md](05_GCSデプロイ手順.md) 参照）。
...
- [Webots シミュレーション構成](06_Webotsシステム構成.md)
- [Webots 連携シミュレーションの概要](07_Webots概要.md)
- [Webサーバーへのデプロイ手順](05_GCSデプロイ手順.md)
