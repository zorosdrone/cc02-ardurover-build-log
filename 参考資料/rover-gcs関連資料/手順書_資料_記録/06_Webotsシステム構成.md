> 元ファイル: `C:\Users\ta1na\source\rover-gcs\docs\architecture_webots.md`
> 取得日: 2026-06-08
> 種別: シミュレーション資料
...
詳細手順は [08_Webotsセットアップ手順.md](08_Webotsセットアップ手順.md) を参照してください。
...
この経路は [03_GCSシステム構成.md](03_GCSシステム構成.md) の「Frontend ⇔ Backend ⇔ Rover」と同じです（Rover が SITL に置き換わるだけ）。
...
詳細は [09_Webots_WebRTC連携.md](09_Webots_WebRTC連携.md) を参照してください。
