...
```text
projects/02_チューニング/params/tuned/20260612_01_after_lidar_simple_avoid_acro_margin1_stop_check.param
```
...
```text
projects/02_チューニング/logs/accepted/20260612_02_lidar_simple_avoid_acro_margin2_outdoor_stop_check.bin
```

候補パラメータ名:

```text
projects/02_チューニング/params/tuned/20260612_02_after_lidar_simple_avoid_acro_margin2_outdoor_stop_check.param
```
