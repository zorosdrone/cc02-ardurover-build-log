...
projects/02_チューニング/params/tuned/YYYYMMDD_NN_after_<内容>.param
projects/02_チューニング/logs/accepted/YYYYMMDD_NN_<内容>.bin
projects/02_チューニング/logs/test_runs/YYYYMMDD_NN_<内容>.md
```
...
projects/02_チューニング/logs/test_runs/20260611_03_acro_low_speed_check.md
```
...
```text
projects/02_チューニング/logs/accepted/20260611_08_lidar_simple_avoid_acro_stop_check.bin
projects/02_チューニング/params/tuned/20260611_08_after_lidar_simple_avoid_acro_stop_check.param
```
...
```text
projects/02_チューニング/logs/test_runs/20260613_01_lidar_simple_avoid_acro_stop_recheck.md
projects/02_チューニング/params/tuned/20260613_01_after_lidar_simple_avoid_acro_stop_recheck.param
```
...
| パラメータ | 凍結版 `.param` を `projects/02_チューニング/params/tuned/` に保存 |
| ログ | 受け入れ走行ログの外部保存先を記録 |

凍結パラメータ名:

```text
projects/02_チューニング/params/tuned/YYYYMMDD_pixhawk6c_rover_tuned_01.param
```
...
```text
projects/02_チューニング/params/tuned/20260613_08_oa_type1_bendyruler_test.param
```
...
```text
projects/02_チューニング/logs/test_runs/20260613_99_end_of_day_tuning_summary.md
```
...
```text
projects/02_チューニング/logs/test_runs/20260613_05_quiktune_precheck.md
projects/02_チューニング/params/tuned/20260613_05_before_quiktune.param
projects/02_チューニング/params/tuned/20260613_06_after_quiktune.param
projects/02_チューニング/logs/test_runs/20260613_06_quiktune_result.md
```
...
`projects/02_チューニング/params/tuned/20260613_06_after_quiktune.param` は保存済み。通常運用向けの終了版は `projects/02_チューニング/params/tuned/20260613_pixhawk6c_rover_tuned_01.param` とする。
