...
cd ~/ardupilot
mkdir -p scripts
cp /mnt/c/path/to/cc02-ardurover-build-log/projects/03_Lua障害物回避/scripts/luaoa_rangefinder_watch.lua scripts/
```
...
REPLでのAPI確認方法は、[補助機能/12_REPLでLuaAPIを確認する.md](補助機能/12_REPLでLuaAPIを確認する.md) を参照する。
