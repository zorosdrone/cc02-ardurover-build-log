...
> 本書はv7～v8.1時点の後退失敗を解析した履歴である。本文中の「現行v8.1」は記録当時の表現であり、現在の実機版と設定値は[プロジェクト概要](../../README.md)を参照する。
...
![Rover後退失敗のグラフ付き解説](../../images/20260727_rover_backup_pwm_failure_infographic.png)
